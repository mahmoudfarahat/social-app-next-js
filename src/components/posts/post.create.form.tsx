                        ...
                        <PopoverContent>
                            <form action={action}>
                                <div className='flex flex-col gap-4 p-4 w-80'>
                                    ...
                                    <Textarea   name="content" label="Content" labelPlacement="outside" placeholder="Describe your content" 
                                       isInvalid={!!formState.errors.content}
                                       errorMessage={formState.errors.content?.join(', ')}/>


                                       {formState.errors._form? <div className="rounded p-2 bg-red-200 border border-red-40">{formState.errors._form?.join(', ')}</div> : null}
